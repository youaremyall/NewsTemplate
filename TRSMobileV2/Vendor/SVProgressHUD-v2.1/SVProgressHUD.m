...
//        [window addSubview:self.overlayView];
        ...
        for (UIWindow *window in frontToBackWindows) {
            ...
            BOOL windowIsReally = window.bounds.size.height == UIScreen.mainScreen.bounds.size.height;
            
            if(windowOnMainScreen && windowIsVisible && windowLevelNormal && windowIsReally) {
                [window addSubview:self.overlayView];
                break;
            }
        }

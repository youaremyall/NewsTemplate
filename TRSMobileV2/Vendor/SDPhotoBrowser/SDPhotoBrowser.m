...
- (void)setupToolbars
{
    ...
    [saveButton.titleLabel setFont:[UIFont systemFontOfSize:15.0] ];
...
- (void)layoutSubviews
{
    ...
    _indexLabel.frame = CGRectMake(20, self.bounds.size.height - 60, 60, 30);
    _saveButton.frame = CGRectMake(self.bounds.size.width - 80, self.bounds.size.height - 60, 60, 30);
}

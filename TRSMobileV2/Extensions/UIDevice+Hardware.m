...
- (NSUInteger) platformType
{
    ...
    if ([platform hasPrefix:@"iPhone8,1"])          return UIDevice6SPlusiPhone;
    if ([platform hasPrefix:@"iPhone8,2"])          return UIDevice6SiPhone;
    // iPod
    ...
    if ([platform hasPrefix:@"iPad2,5"]
        ...
        || [platform hasPrefix:@"iPad2,7"])         return UIDeviceMini1iPad;
    ...
    if ([platform hasPrefix:@"iPad4,1"]
        ...
        || [platform hasPrefix:@"iPad4,3"])         return UIDeviceAir1iPad;
    if ([platform hasPrefix:@"iPad4,4"]
        || [platform hasPrefix:@"iPad4,5"]
        || [platform hasPrefix:@"iPad4,6"])         return UIDeviceMini2iPad;
    if ([platform hasPrefix:@"iPad4,7"]
        || [platform hasPrefix:@"iPad4,8"]
        || [platform hasPrefix:@"iPad4,9"])         return UIDeviceMini3iPad;
